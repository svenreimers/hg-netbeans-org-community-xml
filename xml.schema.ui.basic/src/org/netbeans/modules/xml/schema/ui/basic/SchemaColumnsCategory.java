...
public class SchemaColumnsCategory extends AbstractCategory {
    ...
    private SchemaColumnsView component;
    /** Our lookup. */
     ...
     */
    public SchemaColumnsCategory(SchemaModel model, Lookup lookup) {
...
//            new XPathSearchProvider(model, this),
    ...
    public void componentShown() {
        initComponents();
        SchemaSettings.getDefault().setViewMode(ViewMode.COLUMN);
    }
    ...
    public String getDescription() {
        return NbBundle.getMessage(SchemaColumnsCategory.class,
    ...
    private void initComponents() {
        if (component == null) {
            component = new SchemaColumnsView(schemaModel,
                    SchemaColumnsView.ViewType.CATEGORIZED, getLookup());
        }
    }
