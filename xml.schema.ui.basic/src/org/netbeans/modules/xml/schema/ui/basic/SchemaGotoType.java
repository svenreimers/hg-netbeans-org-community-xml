...
/**
 * GotoType for showing a component in the schema view (tree/columns).
 *
 */
public class SchemaGotoType extends GotoType {

    public String getName() {
        return NbBundle.getMessage(SchemaGotoType.class,
