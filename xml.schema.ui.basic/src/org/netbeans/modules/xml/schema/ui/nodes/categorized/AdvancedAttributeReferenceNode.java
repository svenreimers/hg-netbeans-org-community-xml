...
import org.netbeans.modules.xml.schema.ui.nodes.schema.AttributeReferenceNode;
...
public class AdvancedAttributeReferenceNode extends AttributeReferenceNode {
     ...
     *
     */
    public AdvancedAttributeReferenceNode(SchemaUIContext context,
    ...
    public void propertyChange(PropertyChangeEvent event) {
        ...
        if(event.getSource() == getReference().get() &&
                AttributeReference.REF_PROPERTY.equals(event.getPropertyName())) {
