 ...
 *
 */
public class LengthNode extends SchemaComponentNode<Length>
{
    /**
     *
     *
     */
    public LengthNode(SchemaUIContext context, 
	...
	{
		return NbBundle.getMessage(LengthNode.class,
			"LBL_LengthNode_TypeDisplayName"); // NOI18N
	}
    ...
    protected Sheet createSheet() 
    {
        ...
        try {
            ...
            Property fixedProp = new BooleanProperty(
                    ...
                    Length.FIXED_PROPERTY, // property name
                    NbBundle.getMessage(LengthNode.class,"PROP_Facet_Fixed_DisplayName"), // display name
                    NbBundle.getMessage(LengthNode.class,"PROP_Facet_Fixed_ShortDescription"),	// descr
            ...
            Property valueProp = new NonNegativeIntegerProperty.Primitive(
                    getReference().get(), // schema component,
                    Length.VALUE_PROPERTY,
                    NbBundle.getMessage(LengthNode.class,"PROP_Facet_Value_DisplayName"), // display name
                    NbBundle.getMessage(LengthNode.class,"PROP_Facet_Value_ShortDescription")	// descr
                    );
