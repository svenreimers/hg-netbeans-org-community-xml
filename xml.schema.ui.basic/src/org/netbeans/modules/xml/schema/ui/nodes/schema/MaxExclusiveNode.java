 ...
 *
 */
public class MaxExclusiveNode extends SchemaComponentNode<MaxExclusive>
{
    /**
     *
     *
     */
    public MaxExclusiveNode(SchemaUIContext context, 
	...
	{
		return NbBundle.getMessage(MaxExclusiveNode.class,
			"LBL_MaxExclusiveNode_TypeDisplayName"); // NOI18N
	}
    ...
    protected Sheet createSheet() 
    {
        ...
        try {
            ...
            Property fixedProp = new BooleanProperty(
                    ...
                    MaxExclusive.FIXED_PROPERTY, // property name
                    NbBundle.getMessage(MaxExclusiveNode.class,"PROP_Facet_Fixed_DisplayName"), // display name
                    NbBundle.getMessage(MaxExclusiveNode.class,"PROP_Facet_Fixed_ShortDescription"),	// descr
