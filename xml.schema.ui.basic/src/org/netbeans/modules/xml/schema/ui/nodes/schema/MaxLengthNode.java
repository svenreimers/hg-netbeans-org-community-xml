 ...
 *
 */
public class MaxLengthNode extends SchemaComponentNode<MaxLength>
{
    /**
     *
     *
     */
    public MaxLengthNode(SchemaUIContext context, 
	...
	{
		return NbBundle.getMessage(MaxLengthNode.class,
			"LBL_MaxLengthNode_TypeDisplayName"); // NOI18N
	}
    ...
    protected Sheet createSheet() 
    {
        ...
        try {
            ...
            Property fixedProp = new BooleanProperty(
                    ...
                    MaxLength.FIXED_PROPERTY, // property name
                    NbBundle.getMessage(MaxLengthNode.class,"PROP_Facet_Fixed_DisplayName"), // display name
                    NbBundle.getMessage(MaxLengthNode.class,"PROP_Facet_Fixed_ShortDescription"),	// descr
            ...
            Property valueProp = new NonNegativeIntegerProperty.Primitive(
                    getReference().get(), // schema component
                    MaxLength.VALUE_PROPERTY,
                    NbBundle.getMessage(MaxLengthNode.class,"PROP_Facet_Value_DisplayName"), // display name
                    NbBundle.getMessage(MaxLengthNode.class,"PROP_Facet_Value_ShortDescription")	// descr
                    );
