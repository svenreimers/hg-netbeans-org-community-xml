 ...
 *
 */
public class MinInclusiveNode extends SchemaComponentNode<MinInclusive>
{
    /**
     *
     *
     */
    public MinInclusiveNode(SchemaUIContext context, 
	...
	{
		return NbBundle.getMessage(MinInclusiveNode.class,
			"LBL_MinInclusiveNode_TypeDisplayName"); // NOI18N
	}
    ...
    protected Sheet createSheet() 
    {
        ...
        try {
            ...
            Property fixedProp = new BooleanProperty(
                    ...
                    MinInclusive.FIXED_PROPERTY, // property name
                    NbBundle.getMessage(MinInclusiveNode.class,"PROP_Facet_Fixed_DisplayName"), // display name
                    NbBundle.getMessage(MinInclusiveNode.class,"PROP_Facet_Fixed_ShortDescription"),	// descr
