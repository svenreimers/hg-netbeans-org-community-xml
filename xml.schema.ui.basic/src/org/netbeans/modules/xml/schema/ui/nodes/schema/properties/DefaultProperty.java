 ...
 *
 */
public class DefaultProperty extends BaseSchemaProperty {
    
    /** Creates a new instance of DefaultProperty */
    public DefaultProperty(SchemaComponent component, String propName,
            String propDesc) throws NoSuchMethodException {
        super(component,String.class,Element.DEFAULT_PROPERTY,
    ...
    private void throwError(){
        String msg = NbBundle.getMessage(GlobalElementNode.class, "MSG_Default_FixedAlreadySet"); //NOI18N
