...
public class Retriver_0003 extends Retriver {
    ...
    static final String TEST_JAVA_APP_NAME = "java4retriver_0003";
    ...
    public Retriver_0003(String arg0) {
        super(arg0);
    }

    /*    
    public static TestSuite suite() {
        TestSuite testSuite = new TestSuite(Retriver_0003.class.getName());
        
        for (String strMethodName : m_aTestMethods) {
            testSuite.addTest(new Retriver_0003(strMethodName));
        }
    ...
    */
    ...
    public static Test suite( )
    {
      return NbModuleSuite.create(
          NbModuleSuite.createConfiguration( Retriver_0003.class ).addTest(
              "CreateJavaApplication",
              "CreateSchema"
           )
           .enableModules( ".*" )
    ...
    public void CreateSchema( )
    {
      ...
      jtURL.setText( "http://www.netbeans.org/test.xsd" );

      fwNew.finish( );

      // Check warning
      JDialogOperator jdError = new JDialogOperator( "Error" );
      JLabelOperator jlText = new JLabelOperator( jdError, "File not found in the specified address : http://www.netbeans.org/test.xsd" );
      JButtonOperator jbOk = new JButtonOperator( jdError, "OK" );
      jbOk.push( );
      jdError.waitClosed( );

      // TODO : check there is NO new node.
      /*
      ...
      */
      ...
      String[] asIdeal =
      {
        "Retrieving Location: http://www.netbeans.org/test.xsd ",
        "Error: File not found in the specified address : http://www.netbeans.org/test.xsd"
      };
