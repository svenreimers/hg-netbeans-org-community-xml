...
public class Retriver_0004 extends Retriver {
    
    static final String TEST_JAVA_APP_NAME = "java4retriver_0004";
    ...
    public Retriver_0004(String arg0) {
        super(arg0);
    }

    /*    
    public static TestSuite suite() {
        TestSuite testSuite = new TestSuite(Retriver_0004.class.getName());
        
        for (String strMethodName : m_aTestMethods) {
            testSuite.addTest(new Retriver_0004(strMethodName));
        }
    ...
    */
    ...
    public static Test suite( )
    {
      return NbModuleSuite.create(
          NbModuleSuite.createConfiguration( Retriver_0004.class ).addTest(
              "CreateJavaApplication",
              "CreateSchema"
           )
           .enableModules( ".*" )
    ...
    public void CreateSchema( )
    {
      ...
      JButtonOperator jbBrowse = new JButtonOperator( jnew, "Browse", 1 );
      ...
      TreePath path = jtTree.findPath( "test" );
