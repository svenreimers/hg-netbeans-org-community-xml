...
public abstract class CompositeDataEditorPanel extends JPanel {
    ...
    public static final String PROPERTY_VALIDATION_RESULT = "VALIDATION_RESULT";

    /**
     * Gets the composite data being edited.
     * 
     * @return the composite data.
     */
    public abstract CompositeData getCompositeData();
}
