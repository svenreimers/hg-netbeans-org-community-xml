...
public class MimeValidatorSchemaFactory extends ValidatorSchemaFactory{
    static final String mimeXSDUrl = "/org/netbeans/modules/xml/wsdlextui/resources/soap/mime.xsd";
    ...
    public InputStream getSchemaInputStream() {
        return MimeValidatorSchemaFactory.class.getResourceAsStream(mimeXSDUrl);
    }
    ...
    public Source getSchemaSource() {
        InputStream in = MimeValidatorSchemaFactory.class.getResourceAsStream(mimeXSDUrl);
        Source s = new StreamSource(in);
        s.setSystemId(MimeValidatorSchemaFactory.class.getResource(mimeXSDUrl).toString());
        return s;
    }
}
