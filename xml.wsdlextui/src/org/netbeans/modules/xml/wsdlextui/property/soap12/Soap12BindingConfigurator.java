...
public class Soap12BindingConfigurator extends ExtensibilityElementConfigurator {
    
    
    private static QName bindingQName = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", "binding");
    private static QName operationQName = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", "operation");
    ...
    public Soap12BindingConfigurator() {
    }
        ...
        if (bindingQName.equals(qname)) {
            if ("transport".equals(attributeName)) {
                ...
                try {
                    ...
                    property.setName(SOAP12Binding.TRANSPORT_URI_PROPERTY);
                    property.setDisplayName(NbBundle.getMessage(Soap12AddressConfigurator.class, "PROP_NAME_BINDING_TRANSPORT"));
    ...
    public String getTypeDisplayName(ExtensibilityElement extensibilityElement, QName qname) {
        if (qname.equals(bindingQName))
            return NbBundle.getMessage(Soap12BindingConfigurator.class, "LBL_SoapBinding_TypeDisplayName");
        else if (qname.equals(operationQName)) 
            return NbBundle.getMessage(Soap12BindingConfigurator.class, "LBL_SoapOperation_TypeDisplayName");
        return null;
    }
