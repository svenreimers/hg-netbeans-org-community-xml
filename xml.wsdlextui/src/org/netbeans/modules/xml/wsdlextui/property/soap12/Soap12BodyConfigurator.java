...
public class Soap12BodyConfigurator extends ExtensibilityElementConfigurator {


    private static QName myQName = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", "body");

    private static QName[] supportedQNames = {myQName};
    /** Creates a new instance of SoapBodyConfigurator */
    public Soap12BodyConfigurator() {
    }
        ...
        if (myQName.equals(qname)) {
            if ("parts".equals(attributeName)) {
                try {
                    ...
                    property.setName(SOAP12Body.PARTS_PROPERTY);
                    property.setDisplayName(NbBundle.getMessage(Soap12AddressConfigurator.class, "PROP_NAME_BODY_PARTS"));
    ...
    public String getTypeDisplayName(ExtensibilityElement extensibilityElement, QName qname) {
        return NbBundle.getMessage(Soap12BodyConfigurator.class, "LBL_SoapBody_TypeDisplayName");
    }
}
