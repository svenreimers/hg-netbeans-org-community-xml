...
public class Soap12FaultConfigurator extends ExtensibilityElementConfigurator {
    
    
    private static QName faultQName = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", "fault");
    
    private static QName[] supportedQNames = {faultQName};
    /** Creates a new instance of SoapHeaderConfigurator */
    public Soap12FaultConfigurator() {
    }
    ...
    public Node.Property getProperty(ExtensibilityElement extensibilityElement, QName qname, String attributeName) {
        ...
        if (faultQName.equals(qname)) {
            if ("name".equals(attributeName)) {
                String displayName = NbBundle.getMessage(Soap12FaultConfigurator.class, "PROP_NAME_FAULT_NAME");
                property = new ReadOnlyProperty(new ExtensibilityElementPropertyAdapter(extensibilityElement, "name"), SOAP12Fault.NAME_PROPERTY, String.class, displayName, null);
            }
        }
        return property;
    }
    ...
    public String getTypeDisplayName(ExtensibilityElement extensibilityElement, QName qname) {
        return NbBundle.getMessage(Soap12FaultConfigurator.class, "LBL_SoapFault_TypeDisplayName");
    }
}
