    ...
    private void processBindingOperationInput(SOAP12Binding.Style style, BindingInput bIn) {
            ...
            while(it.hasNext()) {
                ...
                if(ee instanceof SOAP12Body) {
                    ...
                    SOAP12Body.Use use = sBody.getUse();
                    if(use != null) {
                        ...
                        if(inputRef != null && inputRef.get() != null) {
                            ...
                            if(use.equals(SOAP12Body.Use.LITERAL)) {
                                if(style.equals(SOAP12Binding.Style.DOCUMENT)) {
                                    processSoapBodyForDocumentLiteral(messageRef);
                                } else if (style.equals(SOAP12Binding.Style.RPC)) {
    ...
    private void processSoapBodyForDocumentLiteral(NamedComponentReference<Message> messageRef) {
        if(messageRef != null && messageRef.get() != null) {
            ...
            if(message.getParts().size() > 1) {
                String desc = NbBundle.getMessage(Soap12BindingValidator.class, "LBL_doc_literal_R2210");
                ...
                if(it.hasNext()) {
                    ...
                    //if(part.getType() != null && part.getType().get() != null) {
                        String desc = NbBundle.getMessage(Soap12BindingValidator.class, "LBL_doc_literal_R2204");
                        ValidationInfo vInfo = 
                            new ValidationInfo(ValidationInfo.ValidationType.ERROR, desc);
                        this.mVList.add(vInfo);        
                    }
            ...
            Message message = messageRef.get();
                ...
                if(it.hasNext()) {
                    ...
                    //if(part.getElement() != null && part.Element().get() != null) {
                        String desc = NbBundle.getMessage(Soap12BindingValidator.class, "LBL_rpc_literal_R2203");
                        ValidationInfo vInfo = 
                            new ValidationInfo(ValidationInfo.ValidationType.ERROR, desc);
                        this.mVList.add(vInfo);        
                    }
