...
public class Soap12TemplateProvider extends ExtensibilityElementTemplateProvider {
    
    static final String soapTemplateUrl = "/org/netbeans/modules/xml/wsdlextui/template/soap12/template.xml";

    
    public InputStream getTemplateInputStream() {
        return Soap12TemplateProvider.class.getResourceAsStream(soapTemplateUrl);
    }

    
    public String getLocalizedMessage(String str, Object[] objects) {
        return NbBundle.getMessage(Soap12TemplateProvider.class, str, objects);
    }
    ...
    public void postProcess(String  wsdlTargetNamespace, Binding binding) {
        Soap12BindingPostProcessor processor = new Soap12BindingPostProcessor();
    ...
    public List<ValidationInfo> validate(Binding binding) {
        Soap12BindingValidator validator = new Soap12BindingValidator();
