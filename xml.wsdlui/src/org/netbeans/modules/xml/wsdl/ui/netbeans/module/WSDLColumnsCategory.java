...
public class WSDLColumnsCategory extends AbstractCategory {
    ...
    private WSDLColumnsView component;
    /** Our lookup. */
    private Lookup lookup;

    /**
     * Creates a new instance of WSDLColumnsCategory.
     *
     * @param  model   model to display.
     * @param  lookup  associated Lookup instance.
     */
    public WSDLColumnsCategory(WSDLModel model, Lookup lookup) {
        wsdlModel = model;
    ...
    public void componentShown() {
        initComponents();
        WSDLSettings.getDefault().setViewMode(ViewMode.COLUMN);
    }
    ...
    public String getDescription() {
        return NbBundle.getMessage(WSDLColumnsCategory.class,
                "HINT_WsdlCategory_Column");
    }
    ...
    private void initComponents() {
        if (component == null) {
            component = new WSDLColumnsView(wsdlModel, getLookup());
        }
    }
