...
public class PropertyAliasFolderNode extends AbstractNode {
    ...
    private static final Image ICON  = ImageUtilities.loadImage
         ("org/netbeans/modules/xml/wsdl/ui/view/resources/propertyAliasFolder.png");
    
    
    public PropertyAliasFolderNode() {
        super(new Children.Array());
        this.setDisplayName(IWSDLPanelConstants.PROPERTY_ALIAS_FOLDER_NODE_NAME);
    }
