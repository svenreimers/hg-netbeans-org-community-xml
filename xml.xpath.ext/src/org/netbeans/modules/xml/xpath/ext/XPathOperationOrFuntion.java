...
public interface XPathOperationOrFuntion<NameType> extends XPathExpression {
     ...
     */
    List<XPathExpression> getChildren();
    ...
    void insertChild(int index, XPathExpression child);
    
    /**
     * Adds the specified count of new childern. All children are 
     * the core function stub(). 
     * 
     * @param count
     */
    void populateWithStub(int count);
