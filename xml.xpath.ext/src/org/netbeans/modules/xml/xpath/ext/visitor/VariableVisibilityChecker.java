...
public class VariableVisibilityChecker extends XPathModelTracerVisitor {
    ...
    private boolean mHasUnknownVariable = false;

    public boolean hasUnknownVariable() {
        return mHasUnknownVariable;
    }

    @Override
    public void visit(XPathVariableReference varRef) {
        XPathVariable variable = varRef.getVariable();
        if (variable == null) {
            mHasUnknownVariable = true;
        }
    }
